        ...
        <section className="py-16 bg-white border-t border-gray-100 mt-8">
            <div className="max-w-4xl mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-[#1a2744]">Domande Frequenti</h2>
                    <p className="text-gray-600 mt-2">Tutto quello che devi sapere prima di ordinare.</p>
                </div>
    ...
    <main className="min-h-screen bg-white font-inter text-[#1a2744] overflow-x-hidden max-w-[100vw]">
        ...
        <div className="max-w-7xl mx-auto w-full px-3 py-3 flex items-center justify-between">
          <div className="flex flex-col md:flex-row md:items-center md:gap-4">
             <div className="flex items-center gap-2 text-white/90 text-xs md:text-sm font-medium mb-1 md:mb-0">
                ...
                <span>Offerta Lampo scade tra: <span className="text-yellow-400 font-mono font-bold">{timeLeft.m}:{timeLeft.s < 10 ? `0${timeLeft.s}` : timeLeft.s}</span></span>
             </div>
             <div className="flex items-baseline gap-2">
                <p className="text-white font-extrabold text-xl">69,90€</p>
                <p className="text-gray-400 text-xs line-through">233€</p>
             </div>
          </div>
          <button
      ...
      <nav className="border-b border-gray-100 py-4 bg-white sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-4 text-sm font-medium text-gray-600">
                <span className="flex items-center gap-1 text-green-600 font-bold bg-green-50 px-2 py-1 rounded-full text-xs uppercase tracking-wide"><Radio size={14} className="animate-pulse"/> Disponibile Ora</span>
            </div>
        </div>
      </nav>
      ...
      <div className="bg-yellow-400 text-[#1a2744] py-3 px-4 text-center font-bold text-sm md:text-base border-b-2 border-yellow-500 shadow-sm relative z-30">
        <div className="flex items-center justify-center gap-2 animate-pulse">
            ...
            <span>ALLERTA FESTIVITÀ: Dicembre è il mese record per i furti in casa. Proteggiti prima di partire.</span>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6 bg-white p-2 rounded-full shadow-sm w-fit pr-6 border border-gray-100">
                    <div className="flex -space-x-3">
                        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=64&h=64" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                        <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=64&h=64" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=64&h=64" alt="Cliente" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-xs text-gray-600 font-bold">15.420+ Famiglie Protette</p>
                    </div>
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-[1.1] text-[#1a2744] tracking-tight">
                  Non aspettare che sia <span className="text-blue-600">troppo tardi</span>.<br/>
                  Proteggi chi ami oggi stesso.
                </h1>

                <p className="text-lg text-gray-600 mb-6 leading-relaxed max-w-lg">
                  <strong>4 microtelecamere 4K</strong>, 4 sensori porte, telecomando, sirena, chiamata automatica alle forze dell'ordine e notifiche istantanee. <strong>Tutto senza abbonamenti mensili.</strong>
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center gap-2 bg-white border border-gray-200 p-2 rounded-lg shadow-sm">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs font-bold text-gray-800">GARANZIA ITALIA</span>
                            <span className="text-[10px] text-gray-500">2 Anni + Assistenza</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 bg-white border border-gray-200 p-2 rounded-lg shadow-sm">
                        <Truck className="text-blue-500" size={20} />
                        <div className="flex flex-col">
                            <span className="text-xs font-bold text-gray-800">SPEDIZIONE 24H</span>
                            <span className="text-[10px] text-gray-500">Paga alla Consegna</span>
                        </div>
                    </div>
                </div>
                        ...
                        />
                         <div className="absolute -bottom-6 -right-6 bg-yellow-400 text-[#1a2744] font-black px-6 py-3 rounded-xl shadow-lg transform rotate-[-3deg] border-2 border-white">
                            <div className="text-[10px] uppercase font-bold text-[#1a2744]/70 mb-0.5 flex items-center gap-1">
                                <Factory size={10} /> Prezzo Fabbrica
                            </div>
                            <span className="text-3xl">69,90€</span>
                        </div>
                    </div>
               </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Hai 7 secondi per fermarli.
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              La maggior parte dei furti avviene mentre sei al lavoro o in vacanza. Il nostro sistema ti avvisa PRIMA che riescano a forzare la serratura.
            </p>
          </div>
      ...
      <section className="py-12 bg-gray-50 border-y border-gray-200">
         <div className="max-w-7xl mx-auto px-4">
             ...
             <p className="text-center text-sm text-gray-500 mt-6 italic">
                *Screenshot reali dell'interfaccia utente. Puoi collegare fino a 10 telecamere.
             </p>
         </div>
      </section>
      ...
      <section className="pt-12 bg-white border-b border-gray-100 overflow-hidden">
         <div className="max-w-7xl mx-auto px-4">
             <div className="text-center mb-16">
                 <h2 className="text-2xl md:text-3xl font-bold text-[#1a2744]">Piccole. Potenti. Invisibili.</h2>
                 <p className="text-gray-600 mt-2">Tecnologia che si fonde con il tuo arredamento. Tu la controlli, gli altri non la vedono.</p>
             </div>
                            ...
                            <div className="bg-gray-900 aspect-[9/19] flex flex-col relative overflow-hidden">
                                ...
                                <div className="bg-red-600 text-white p-2 pt-3 text-center animate-pulse">
                                    <div className="flex items-center justify-center gap-1">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-wider">RILEVATA INTRUSIONE</span>
                                    </div>
                                </div>
                                ...
                                <div className="relative flex-grow bg-gray-800 max-h-[60%] overflow-hidden">
                                    ...
                                    <div className="absolute top-1/4 left-1/3 w-16 h-16 border-2 border-red-500 rounded-sm">
                                        <div className="absolute -top-4 left-0 bg-red-500 text-white text-[8px] font-bold px-1">PERSONA</div>
                                    </div>
                                ...
                                <div className="bg-gray-900 p-3 space-y-2 relative z-10 border-t border-gray-800">
                                    <div className="flex gap-2">
                                        <button className="flex-1 bg-red-600 text-white py-3 rounded-lg flex flex-col items-center justify-center gap-0.5 shadow-lg active:scale-95 transition-transform border border-red-500">
                                            ...
                                            <span className="text-[9px] font-black">SOS 112</span>
                                        </button>
                                        <button className="flex-1 bg-yellow-400 text-black py-3 rounded-lg flex flex-col items-center justify-center gap-0.5 shadow-lg active:scale-95 transition-transform border border-yellow-300">
                                            ...
                                            <span className="text-[9px] font-black">SIRENA</span>
                                        </button>
                                    </div>
                                    <button className="w-full bg-white/10 text-white py-2 rounded-lg flex items-center justify-center gap-2 border border-white/20 active:bg-white/20">
                                        <Mic size={14} /> <span className="text-[10px] font-bold">PARLA (VOCE)</span>
                                    </button>
                                </div>
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-1 sm:col-span-2 mt-4 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100">
                        <h4 className="font-bold text-[#1a2744] flex items-center gap-2 mb-2">
                            ...
                            Installazione Automatica (Zero Cavi)
                        </h4>
                        <p className="text-sm text-gray-600 leading-relaxed mb-3">
                            Niente tecnici. Le <strong>4 telecamere</strong> e i sensori arrivano <strong>già associati</strong> alla centralina. Li accendi e funzionano da soli.
                        </p>
                    </div>
                 </div>
             </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a2744] mb-4">
              Tecnologia Militare alla portata di tutti
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Abbiamo preso la tecnologia dei sistemi da 2.000€ e l'abbiamo resa accessibile e semplice.
            </p>
          </div>
      ...
      <section className="py-16 bg-blue-50 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-[#1a2744] mb-4">Un Click. Tutto Attivo.</h2>
                    ...
                    <div className="space-y-4">
                         <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm text-gray-700">Attivi l'allarme col telecomando uscendo di casa.</p>
                         </div>
                         <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-sm">2</div>
                            <p className="text-sm text-gray-700">Le 4 telecamere registrano + i sensori porte si armano.</p>
                         </div>
                         <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold text-sm">3</div>
                            <p className="text-sm text-gray-700">Se succede qualcosa, il sistema ti chiama subito.</p>
                         </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                    ...
                    <div className="space-y-6">
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-[#1a2744] text-sm">4x Microcamere</h4>
                                <p className="text-xs text-gray-500 mt-1">Batteria al Litio ricaricabile. <strong>Autonomia 5 Mesi.</strong> Si ricarica col cavo USB (incluso) come un cellulare.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-[#1a2744] text-sm">Sensori, Sirena & Telecomando</h4>
                                <p className="text-xs text-gray-500 mt-1">Batteria a bottone lunga durata. <strong>Autonomia 5 ANNI.</strong> Sostituibile facilmente (le trovi ovunque).</p>
                            </div>
                        </div>

                        <div className="mt-4 p-4 bg-green-50 rounded-xl border border-green-100 text-center">
                            <p className="text-sm font-bold text-green-700">Tutto Incluso nella scatola</p>
                            <p className="text-xs text-green-600">Non devi comprare nulla a parte.</p>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-center">
                     <div className="flex-1">
                         <h3 className="text-xl font-bold text-[#1a2744] mb-3 flex items-center gap-2">
                             <Wifi className="text-red-500"/> "E se staccano la luce o internet?"
                         </h3>
                         <p className="text-gray-600 text-sm leading-relaxed mb-4">
                             È la prima cosa che fanno i ladri esperti. Ma con BeSecure Pro non funziona.
                         </p>
                         <ul className="space-y-2">
                             <li className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                 <Battery size={16} className="text-green-500"/> Batteria Tampone (12h autonomia extra)
                             </li>
                             <li className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                 <Signal size={16} className="text-blue-500"/> SIM 4G Inclusa (Funziona senza WiFi)
                             </li>
                         </ul>
                     </div>
                     ...
                     <div className="flex-1">
                         <h3 className="text-xl font-bold text-[#1a2744] mb-3 flex items-center gap-2">
                             <Cloud className="text-blue-500"/> "Dove finiscono i video?"
                         </h3>
                         <p className="text-gray-600 text-sm leading-relaxed mb-4">
                             "E se mi rubano la telecamera?". Non importa.
                         </p>
                         <ul className="space-y-2">
                             <li className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                 <HardDrive size={16} className="text-gray-500"/> SD Card 128GB (Registra 24/7)
                             </li>
                             <li className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                 <Cloud size={16} className="text-blue-500"/> Cloud Backup (Le prove sono al sicuro)
                             </li>
                         </ul>
                     </div>
                 </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-[#1a2744] mb-10">
            Perché tutti scelgono BeSecure Pro?
          </h2>
          <div className="overflow-hidden rounded-xl border border-gray-200 shadow-lg">
            <table className="w-full text-sm md:text-base">
              <thead className="bg-gray-50">
                <tr>
                  <th className="p-4 text-left text-gray-500 font-medium">Caratteristica</th>
                  <th className="p-4 text-center font-bold text-[#1a2744] bg-blue-50 w-1/3 border-t-4 border-blue-500">NOI</th>
                  <th className="p-4 text-center text-gray-400 font-normal w-1/3">Altri</th>
                </tr>
              </thead>
            ...
            <div className="bg-gray-50 rounded-3xl p-8 shadow-xl border border-gray-100 flex flex-col md:flex-row gap-10 items-center">
                ...
                <div className="w-full md:w-1/2">
                    <h3 className="text-xl font-bold text-[#1a2744] mb-6 flex items-center gap-2">
                        <Package className="text-blue-600"/> Kit Completo "Fortezza"
                    </h3>
            ...
            <div className="mb-12 text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="font-bold text-sm text-[#1a2744]">Compila il modulo</div>
                        <p className="text-xs text-gray-500 mt-1">Inserisci i tuoi dati qui sotto</p>
                    </div>
                    <div className="flex flex-col items-center relative">
                        ...
                        <div className="font-bold text-sm text-[#1a2744]">Attendi Conferma</div>
                        <p className="text-xs text-gray-500 mt-1">Ti chiamiamo per conferma</p>
                    </div>
                    <div className="flex flex-col items-center relative">
                        <div className="hidden md:block absolute top-6 -left-1/2 w-full h-0.5 bg-blue-100 -z-10"></div>
                        ...
                        <div className="font-bold text-sm text-[#1a2744]">Spedizione Rapida</div>
                        <p className="text-xs text-gray-500 mt-1">Parte in 24/48h</p>
                    </div>
                    <div className="flex flex-col items-center relative">
                        <div className="hidden md:block absolute top-6 -left-1/2 w-full h-0.5 bg-blue-100 -z-10"></div>
                        ...
                        <div className="font-bold text-sm text-[#1a2744]">Paga alla Consegna</div>
                        <p className="text-xs text-gray-500 mt-1">In contanti al corriere</p>
                    </div>
                </div>
            </div>
