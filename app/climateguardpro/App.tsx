...
// Usa la prop 'src' per inserire l'URL della tua immagine.
// Es: <ImagePlaceholderDark src="https://..." label="..." />

const ImagePlaceholder = ({ src, label, height = "h-56 md:h-full", className = "" }: { src?: string, label: string, height?: string, className?: string }) => {
  if (src) {
    return (
      <div className={`w-full ${height} rounded-2xl overflow-hidden shadow-lg ${className}`}>
        <img src={src} alt={label} className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
      </div>
    );
  }
  return (
...
const ImagePlaceholderDark = ({ src, label, height = "h-56 md:h-full", className = "" }: { src?: string, label: string, height?: string, className?: string }) => {
  if (src) {
    return (
      <div className={`w-full ${height} rounded-2xl overflow-hidden shadow-2xl relative group ${className}`}>
...
function App() {
  ...
  // Simplified State: 3 Fields Only
  ...
  return (
    <div className="min-h-screen bg-void-950 font-sans selection:bg-neon-500 selection:text-white w-full overflow-x-hidden">
      ...
      <div className="relative bg-platinum-50 pb-12 md:pb-24 overflow-hidden">
        ...
        {/* Animated Marquee Bar (Faster Speed) */}
          ...
          <div className="grid md:grid-cols-12 gap-6 md:gap-12 items-start min-w-0">
            ...
            <div className="md:col-span-5 flex flex-col min-w-0 relative z-10">
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-display font-black text-void-950 mb-3 md:mb-4 tracking-tighter uppercase leading-[0.9]">
                  Basta bollette <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-500 to-red-600">Salate.</span>
                </h1>
                ...
                {/* 2. BULLET POINTS (IMPROVED READABILITY) */}
      ...
      {/* --- DEEP DIVE MARKETING BODY (DARK MODE STARTS HERE) --- */}
      <div className="bg-void-950 text-white relative overflow-x-hidden w-full pt-10">
        ...
        {/* --- STORY BLOCK 1: IL PARADOSSO (RED GRADIENT) --- */}
           ...
           <div className="max-w-7xl mx-auto relative z-10">
             ...
             <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                ...
                <div className="relative mt-6 md:mt-0">
                   {/* INSERISCI QUI IL LINK FOTO */}
                   <ImagePlaceholderDark src="" label="FOTO: 4 VECCHI ELETTRODOMESTICI VS 1 CLIMATEGUARD" height="h-[300px] md:h-[500px]" className="border-red-500/40 shadow-[0_0_50px_rgba(220,38,38,0.2)]" />
                   <div className="absolute -bottom-4 -right-2 md:-bottom-10 md:-right-10 bg-[#1a0505] border border-red-500/30 p-4 md:p-6 rounded-2xl shadow-2xl flex items-center gap-3 md:gap-5 z-20 max-w-[200px] md:max-w-[240px]">
                      <Package className="w-8 h-8 md:w-12 md:h-12 text-red-500 shrink-0" />
                      <div>
                         <div className="text-xs md:text-sm text-gray-400 uppercase font-bold leading-none mb-1">Spazio</div>
                         <div className="text-white font-bold text-xl md:text-2xl">-75% Ingombro</div>
                      </div>
                   </div>
                </div>
             </ScrollReveal>
        ...
        {/* --- STORY BLOCK 2: PERFORMANCE (BLUE GRADIENT) --- */}
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 <div className="order-2 md:order-1 relative mt-6 md:mt-0">
                    {/* INSERISCI QUI IL LINK FOTO */}
                    <ImagePlaceholderDark src="" label="FOTO: GRAFICO FLUSSO DIFFUSO E CERAMICA PTC" height="h-[300px] md:h-[500px]" className="border-blue-500/40 shadow-[0_0_50px_rgba(59,130,246,0.3)]" />
                    <div className="absolute top-4 -left-2 md:top-12 md:-left-12 bg-[#050b1a] border border-blue-500/30 p-4 md:p-6 rounded-2xl shadow-2xl z-20 min-w-[180px] md:min-w-[200px]">
                       <div className="text-xs md:text-sm text-gray-400 mb-2 uppercase tracking-wide font-bold">Riscaldamento</div>
                       <div className="flex items-end gap-3">
                          <span className="text-4xl md:text-5xl font-bold text-white tracking-tighter">PTC</span>
                          <span className="text-[10px] md:text-xs text-orange-400 mb-2 font-bold bg-orange-900/50 px-2 py-1 rounded border border-orange-500/30">CERAMICA</span>
                       </div>
        ...
        {/* --- STORY BLOCK 3: SALUTE (PURPLE GRADIENT) --- */}
        <section className="py-12 md:py-24 px-4 md:px-6 relative overflow-hidden bg-gradient-to-b from-void-950 via-[#150520] to-void-950">
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 ...
                 <div className="relative mt-6 md:mt-0">
                    {/* INSERISCI QUI IL LINK FOTO */}
                    <ImagePlaceholderDark src="" label="FOTO: FUMI CUCINA E POLLINE CATTURATI DAL FILTRO" height="h-[300px] md:h-[500px]" className="border-purple-500/40 shadow-[0_0_50px_rgba(168,85,247,0.2)]" />
                 </div>
              </ScrollReveal>
           </div>
        </section>

        {/* --- STORY BLOCK 4: ECONOMIA (GREEN GRADIENT) --- */}
        <section className="py-12 md:py-24 px-4 md:px-6 relative overflow-hidden bg-gradient-to-b from-void-950 via-[#021005] to-void-950">
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 <div className="order-2 md:order-1 relative mt-6 md:mt-0">
                    {/* INSERISCI QUI IL LINK FOTO */}
                    <ImagePlaceholderDark src="" label="FOTO: MODALITÀ AUTO E APP" height="h-[300px] md:h-[500px]" className="border-green-500/40 shadow-[0_0_50px_rgba(34,197,94,0.2)]" />
                 </div>
                 <div className="order-1 md:order-2 relative">
        ...
        {/* --- NEW SECTION: INTELLIGENZA E COMFORT (BENTO GRID) --- */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 ...
                 <ScrollReveal delay={0} className="md:col-span-2 h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 group hover:border-neon-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="w-full md:w-1/3 h-48 bg-black/40 rounded-xl border border-white/5 flex items-center justify-center relative overflow-hidden">
                         {/* INSERISCI QUI IL LINK FOTO */}
                         <ImagePlaceholderDark src="" label="APP SCREEN" height="h-full" className="border-0 bg-transparent" />
                      </div>
                   </div>
                 </ScrollReveal>
                 ...
                 <ScrollReveal delay={450} className="md:col-span-2 h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8 group hover:border-green-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="w-full md:w-1/3 h-48 bg-black/40 rounded-xl border border-white/5 flex items-center justify-center relative overflow-hidden">
                         {/* INSERISCI QUI IL LINK FOTO */}
                         <ImagePlaceholderDark src="" label="DISPLAY SPENTO" height="h-full" className="border-0 bg-transparent" />
                      </div>
                   </div>
                 </ScrollReveal>
              </div>
      ...
      <section id="order-form" className="py-12 md:py-24 px-4 md:px-6 bg-[#050508] border-t border-white/10 pb-40 md:pb-24 overflow-hidden relative text-white">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {/* NEW: PROCESS STEPS VISUALIZATION */}
          ...
          <ScrollReveal delay={200} className="bg-void-900/80 border border-white/10 p-6 md:p-10 rounded-3xl shadow-2xl relative overflow-hidden backdrop-blur-xl">
            {/* Scroll Anchor placed DIRECTLY on the form container with offset for header */}
             ...
             {submitted ? (
               ...
               <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                  ...
                  {/* PACKAGE SUMMARY (FIXED 1X OFFER) */}
      ...
      {/* Aggressive Sticky Mobile Bar (Redesigned) */}
