...
export const metadata: Metadata = {
  title: "ClimateGuard Pro - Il Futuro del Clima",
  description: "Il sistema climatico 4-in-1 definitivo. Tecnologia Spaziale per la tua Casa.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="it" className="scroll-smooth overflow-x-hidden">
      <head>
