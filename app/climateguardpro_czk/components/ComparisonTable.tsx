        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              ...
              <th className="px-6 py-5 text-gray-500 font-normal text-sm uppercase text-center opacity-70">Klasické Topení</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-white/5 text-base md:text-lg">
            <tr>
              ...
              <td className="px-6 py-5 text-red-500 text-center font-bold">Velmi Vysoké (Plyn/Elektřina)</td>
            </tr>
            <tr>
              <td className="px-6 py-5 font-medium text-gray-200 flex items-center gap-3"><Thermometer className="w-5 h-5 text-red-500"/> Pokrytí Teplem</td>
              <td className="px-6 py-5 bg-white/5 border-x border-white/10 text-white font-bold">
                90 m² (Rovnoměrné)
              </td>
              <td className="px-6 py-5 text-gray-500 text-center">Pouze u zdroje tepla</td>
            </tr>
            <tr>
              ...
              <td className="px-6 py-5 bg-white/5 border-x border-white/10">
                <span className="px-3 py-1 rounded bg-neon-500/20 text-neon-400 text-sm font-bold border border-neon-500/30">Aktivní Odvlhčování</span>
              </td>
              <td className="px-6 py-5 text-gray-500 text-center">Chybí (Vytváří kondenzaci)</td>
            </tr>
            <tr>
