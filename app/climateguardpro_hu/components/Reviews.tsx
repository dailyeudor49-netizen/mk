...
const reviews: ReviewType[] = [
  {
    ...
    location: "Budapest",
    rating: 5,
    text: "Szkeptikus voltam a 90 négyzetméteres lefedettséggel kapcsolatban, nagy nappali-konyhám van. De be kell vallanom, hogy 20 percen belül mindenhova eljut a meleg levegő. A legjobb? A gázszámla tényleg 40%-kal csökkent a tavalyhoz képest.",
    highlight: "Felére csökkent a rezsi és meleg a ház",
    verified: true,
    timeAgo: "2 napja"
  },
  {
    ...
    location: "Debrecen",
    rating: 5,
    text: "Megoldottam a penészproblémát a hálószobában. Korábban nedves ablakokkal ébredtem, most száraz és meleg a levegő. Éjszaka csendes, végre tudok aludni.",
    highlight: "Viszlát penész és pára",
    verified: true,
  ...
  },
  {
    ...
    location: "Szeged",
    rating: 5,
    text: "A dizájn futurisztikus, úgy néz ki, mint egy 200 000 forintos készülék. Utánvéttel fizettem a futárnak készpénzzel, nulla kockázat. Azonnal melegít, amint bekapcsolod.",
    ...
    <div id="reviews-section" className="bg-void-900 border-y border-white/5 py-16 px-6 scroll-mt-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <ScrollReveal className="text-center mb-12">
          <h3 className="text-3xl md:text-4xl font-display font-bold text-white mb-3">MIT MONDANAK ÜGYFELEINK</h3>
          <div className="flex justify-center items-center gap-3">
            ...
            <span className="text-gray-300 font-bold text-lg">4.9/5 Ellenőrzött Értékelés</span>
          </div>
        </ScrollReveal>
