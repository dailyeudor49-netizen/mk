    ...
    <div className="w-full rounded-3xl border border-white/10 bg-void-900/50 backdrop-blur-xl overflow-hidden relative shadow-2xl">
      ...
      <div className="overflow-x-auto p-6">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              <th className="px-6 py-5 text-gray-400 uppercase tracking-widest font-bold text-sm">Kluczowe Parametry</th>
          ...
          <tbody className="divide-y divide-white/5 text-base md:text-lg">
            ...
            <tr>
              <td className="px-6 py-5 font-medium text-gray-200 flex items-center gap-3"><Thermometer className="w-5 h-5 text-red-500"/> Pokrycie Ciepłem</td>
            ...
            <tr>
              <td className="px-6 py-5 font-medium text-gray-200 flex items-center gap-3"><Droplets className="w-5 h-5 text-blue-500"/> Funkcja Przeciwpleśniowa</td>
            ...
            <tr>
              ...
              <td className="px-6 py-5 bg-white/5 border-x border-white/10 text-white rounded-b-2xl border-b">
                Bez Łopatek & Przeciwoparzeniowe
              </td>
