    ...
    <div className="w-full rounded-3xl border border-white/10 bg-void-900/50 backdrop-blur-xl overflow-hidden relative shadow-2xl">
      ...
      <div className="overflow-x-auto p-6">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              <th className="px-6 py-5 text-gray-400 uppercase tracking-widest font-bold text-sm">Dôležité parametre</th>
              ...
              <th className="px-6 py-5 text-gray-500 font-normal text-sm uppercase text-center opacity-70">Kachle / Radiátory</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-white/5 text-base md:text-lg">
            <tr>
              <td className="px-6 py-5 font-medium text-gray-200 flex items-center gap-3"><Zap className="w-5 h-5 text-yellow-500"/> Náklady na energiu</td>
              ...
              <td className="px-6 py-5 text-red-500 text-center font-bold">Veľmi vysoké (Plyn/Odpor)</td>
            </tr>
            <tr>
              ...
              <td className="px-6 py-5 text-gray-500 text-center">Len pri zdroji</td>
            </tr>
            <tr>
              ...
              <td className="px-6 py-5 text-gray-500 text-center">Žiadne (Vytvára kondenzáciu)</td>
            </tr>
            <tr>
