    ...
    <div className="max-w-7xl mx-auto flex justify-between items-center">
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col leading-none">
           ...
           <span className="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-widest">Oficiálny obchod</span>
        </div>
      </div>
      <button onClick={scrollToForm} className="bg-void-950 hover:bg-neon-500 text-white px-4 py-2 md:px-6 md:py-2.5 rounded-full flex items-center gap-2 transition-all shadow-lg hover:shadow-neon-500/30 transform hover:-translate-y-0.5 group overflow-hidden relative">
        ...
        <span className="hidden md:inline text-sm font-bold tracking-wide relative z-10">ZOBRAZId FORMULÁR</span>
    ...
    <div className="min-h-screen bg-void-950 font-sans selection:bg-neon-500 selection:text-white w-full overflow-x-hidden" style={{ touchAction: 'pan-y' }}>
      ...
      <div className="relative bg-platinum-50 pb-12 md:pb-24 overflow-hidden">
        ...
        <div className="w-full bg-void-950 py-2 md:py-2.5 overflow-hidden border-b border-gray-800 relative z-10">
           <div className="flex animate-marquee whitespace-nowrap gap-8 md:gap-12 text-[10px] md:text-sm font-bold text-white uppercase tracking-widest items-center">
              ...
              <span className="flex items-center gap-2"><Truck className="w-3 h-3 md:w-4 md:h-4 text-neon-500"/> Expedícia z EU skladu</span>
        ...
        <section className="pt-4 md:pt-12 md:pb-16 px-4 md:px-6 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-12 gap-6 md:gap-12 items-start min-w-0">
                ...
                <div className="mt-3 md:mt-4 flex items-center justify-between bg-white border border-gray-200 p-2.5 md:p-3 rounded-lg md:rounded-xl shadow-sm max-w-full">
                   <div className="flex items-center gap-3">
                      ...
                      <div className="leading-tight">
                         <p className="font-bold text-void-950 text-xs md:text-sm"><span className="text-green-600 font-black">{viewers} Návatevníkov</span> online</p>
                         <p className="text-gray-500 text-[10px] md:text-xs">Sledujú túto ponuku</p>
                      </div>
                   </div>
            ...
            <div className="md:col-span-5 flex flex-col min-w-0 relative z-10">
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-display font-black text-void-950 mb-3 md:mb-4 tracking-tighter uppercase leading-[0.9]">
                  Koniec s vysokými <span className="text-orange-500">faktúrami.</span>
                </h1>

                <p className="text-sm md:text-xl text-gray-700 font-medium mb-5 md:mb-6 leading-relaxed">
                   Prvý klimatický systém <strong className="text-void-950 bg-gray-100 px-1 rounded">4-v-1 s umelou inteligenciou</strong>, ktorý vyhrieva váa domov za 18 minút za polovinú cenu.
                </p>
                ...
                <div className="grid grid-cols-1 gap-3 mb-6 md:mb-8">
                   <div className="flex items-start gap-3 bg-white/90 p-3.5 rounded-xl border border-gray-200 shadow-sm backdrop-blur-sm transition-transform hover:scale-[1.02]">
                      ...
                      <div>
                         ...
                         <p className="text-sm text-gray-800 font-medium leading-snug mt-1">Technológia AirMulti" tlaí teplý vzduch do <span className="text-red-600 font-bold underline decoration-red-200">ka~dého kúta</span>, eliminuje studené zóny.</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-start gap-3 bg-white/90 p-3.5 rounded-xl border border-gray-200 shadow-sm backdrop-blur-sm transition-transform hover:scale-[1.02]">
                      ...
                      <div>
                         <h4 className="text-base font-bold text-gray-800 leading-tight">ip ECO-AI (-60% faktúra)</h4>
                         <p className="text-sm text-gray-800 font-medium leading-snug mt-1">Senzory vypínajú odpor na tisícinu sekundy. <span className="text-green-600 font-bold underline decoration-green-200">Nulové plytvanie</span> energiou.</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-start gap-3 bg-white/90 p-3.5 rounded-xl border border-gray-200 shadow-sm backdrop-blur-sm transition-transform hover:scale-[1.02]">
                      ...
                      <div>
                         <h4 className="text-base font-bold text-gray-800 leading-tight">Termický odvlhova</h4>
                         <p className="text-sm text-gray-800 font-medium leading-snug mt-1">Suauje vlhkose zo stien poas vyhrievania. Predchádza <span className="text-purple-600 font-bold underline decoration-purple-200">plesni a kondenzácii</span>.</p>
                      </div>
                   </div>
                   ...
                   <div className="flex items-start gap-3 bg-white/90 p-3.5 rounded-xl border border-gray-200 shadow-sm backdrop-blur-sm transition-transform hover:scale-[1.02]">
                      ...
                      <div>
                         <h4 className="text-base font-bold text-gray-800 leading-tight">Aktívny filter HEPA</h4>
                         <p className="text-sm text-gray-800 font-medium leading-snug mt-1">Zachytáva prach, kuchynské pachy a pe>. Dýchajte istý vzduch aj so zatvorenými oknami.</p>
                      </div>
                   </div>
                </div>
                ...
                <div className="bg-white rounded-2xl md:rounded-3xl border border-gray-200 shadow-2xl relative overflow-hidden ring-4 ring-gray-50/50">
                  <div className="p-5 md:p-6 pb-4 border-b border-gray-100">
                    <div className="flex justify-between items-start mb-4 md:mb-5">
                       <div>
                          <p className="text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Limitovaná ponuka 2025</p>
                       ...
                       <div className="flex flex-col items-end gap-1">
                          ...
                          <span className="text-[10px] text-green-600 font-bold bg-green-50 px-1.5 py-0.5 rounded border border-green-100">Uaetríte 70¬</span>
                       </div>
                    </div>
                    ...
                    <button onClick={scrollToForm} className="w-full bg-neon-500 hover:bg-neon-400 text-white font-bold py-3.5 md:py-4 rounded-xl shadow-[0_4px_14px_0_rgba(255,77,0,0.39)] hover:shadow-[0_6px_20px_rgba(255,77,0,0.23)] hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 text-lg md:text-xl mb-2 group leading-tight relative overflow-hidden">
                        ...
                        <span className="relative z-10">ZOBRAZId FORMULÁR</span>
                  ...
                  <div className="bg-gray-50/80 p-3 md:p-5 space-y-2 md:space-y-3">
                     <div className="flex items-center gap-3">
                        ...
                        <div className="leading-tight">
                           <span className="font-bold text-void-950 text-xs md:text-sm block">Expresné doruenie 24/48h</span>
                           <span className="text-gray-500 text-[10px] md:text-xs">Sledované a poistené doruenie.</span>
                        </div>
                     </div>
                     <div className="flex items-center gap-3">
                        ...
                        <div className="leading-tight">
                           ...
                           <span className="text-gray-500 text-[10px] md:text-xs">Plaete v hotovosti kuriérovi. }iadne riziko.</span>
                        </div>
                     </div>
                  </div>
                </div>
          ...
          <div className="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-gray-200 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
             ...
             <div className="flex flex-col items-center justify-center p-3 md:p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                ...
                <span className="text-[10px] md:text-xs font-bold leading-tight text-center text-gray-600">ENERGETICKÁ<br/>TRIEDA A+++</span>
             </div>
             <div className="flex flex-col items-center justify-center p-3 md:p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                <AwardIcon className="w-6 h-6 md:w-8 md:h-8 text-void-950 mb-2" />
                <span className="text-[10px] md:text-xs font-bold leading-tight text-center text-gray-600">DIZAJNOVÉ<br/>OCENENIE 2025</span>
             </div>
             <div className="flex flex-col items-center justify-center p-3 md:p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
      ...
      <div className="bg-void-950 text-white relative overflow-x-clip w-full pt-10">
             ...
             <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                <div className="relative">
                   ...
                   <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 md:mb-8 leading-tight drop-shadow-lg">
                      PrestaHte vyhadzovae peniaze za <span className="text-red-500 underline decoration-red-900 underline-offset-4">4 rôzne</span> prístroje.
                   </h2>
                   <p className="text-gray-200 text-lg md:text-xl leading-relaxed mb-8 font-light">
                      Poítali ste? Kúpie výkonnú pec, ventilátor, isti vzduchu a odvlhova vás stojí viac ako <strong className="text-red-500 bg-red-950/30 px-1 rounded">800¬</strong>.
                      <br/><br/>
                      <span className="text-white font-bold text-xl border-l-4 border-red-500 pl-4 block">ClimateGuard Pro" je definitívny monolit.</span> Letecký dizajn, ktorý zahUHa 4 technológie v jednom st:pci.
                   </p>
                ...
                <div className="mt-6 md:mt-0">
                   <ImagePlaceholderDark src="/images/climateguardpro img/disordine-vs-ordine.png" label="FOTO: 4 STARÉ SPOTREBIE VS 1 CLIMATEGUARD" height="h-[300px] md:h-[500px]" />
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 <div className="order-2 md:order-1 mt-6 md:mt-0">
                    <ImagePlaceholderDark src="/images/climateguardpro img/performance-calore.png" label="FOTO: GRAF ROZPTÝLENÉHO TOKU A PTC KERAMIKY" height="h-[300px] md:h-[500px]" />
                    <div className="mt-4 md:mt-6 bg-[#050b1a] border border-blue-500/30 p-4 md:p-5 rounded-2xl shadow-2xl max-w-full md:max-w-[280px]">
                       ...
                       <div className="text-xs text-gray-400 mt-2 font-bold text-blue-300">Okam~ité teplo.</div>
                    </div>
                 </div>
                 <div className="order-1 md:order-2 relative">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 md:mb-8 leading-tight drop-shadow-lg">
                       Keramický výkon a <span className="text-blue-500">inteligentný prúd.</span>
                    </h2>
                    <p className="text-gray-200 text-lg md:text-xl leading-relaxed mb-8 font-light">
                       Normálne kachle spa>ujú vzduch a hrejú len pred sebou.
                       ClimateGuard pou~íva <strong className="text-blue-400">keramiku PTC</strong> (okam~ité super úinné vykurovanie) a turbínu, ktorá tlaí <strong className="text-white border-b border-blue-500">290 litrov/sekundu</strong>.
                       <br/><br/>
                       <span className="text-white block mb-2 text-xl flex items-center gap-2">
                         <Sparkles className="w-5 h-5 text-blue-500" />
                         <strong>Rozptýlený re~im:</strong>
                       </span>
                       Vzduch vás nikdy nezasiahne priamo do tváre. Prúd sa presmeruje dozadu, aby objal miestnose príjemným teplom, bez obea~ovania.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                       ...
                       <div className="bg-blue-950/40 p-5 rounded-2xl border border-blue-500/30 text-center shadow-lg hover:bg-blue-900/60 transition-colors min-w-0">
                          ...
                          <div className="text-base md:text-lg font-bold text-white truncate">Oscilácia <span className="text-cyan-400">350°</span></div>
                       </div>
                    </div>
                 </div>
              </ScrollReveal>
        ...
        <section className="py-12 md:py-24 px-4 md:px-6 relative overflow-x-clip overflow-y-visible bg-gradient-to-b from-void-950 via-[#150520] to-void-950">
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              <div className="md:hidden mb-6 flex justify-center">
                 <span className="bg-purple-500/20 text-purple-400 border border-purple-500/50 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider">03. istý vzduch</span>
              </div>
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 <div className="relative">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 md:mb-8 leading-tight drop-shadow-lg">
                       Váa domov je <span className="text-purple-500">5-krát</span> viac zneistený ako vonku.
                    </h2>
                    <div className="text-gray-200 text-lg md:text-xl leading-relaxed mb-8 font-light space-y-4">
                       <p>Zima zatvorené okná = vydýchaný vzduch. Filter <strong className="text-white">HEPA-13 s aktívnym uhlím</strong> pracuje poas vyhrievania:</p>
                       ...
                       <div className="space-y-3">
                         <div className="flex items-start gap-3 p-2 rounded hover:bg-purple-900/20 transition-colors">
                           ...
                           <span><strong className="text-red-400">KuchyHa:</strong> Odstráni pachy z vyprá~ania a rýb za 10 minút.</span>
                         </div>
                         <div className="flex items-start gap-3 p-2 rounded hover:bg-purple-900/20 transition-colors">
                           <Flower2 className="w-6 h-6 text-yellow-500 mt-1 shrink-0" />
                           <span><strong className="text-yellow-400">Alergie:</strong> Zachytí 99,9% pe>u a alergénov.</span>
                         </div>
                         <div className="flex items-start gap-3 p-2 rounded hover:bg-purple-900/20 transition-colors">
                    ...
                    <div className="flex items-center gap-4 md:gap-6 bg-purple-900/30 border border-purple-500/30 p-5 md:p-6 rounded-2xl shadow-lg hover:border-purple-500 transition-all">
                       ...
                       <div className="text-sm md:text-base text-gray-200">
                          ...
                          Zbohom mokré okná a <span className="text-purple-400 font-bold underline decoration-purple-600">ierna pleseH na stenách</span>.
                       </div>
                    </div>
                 </div>
                 <div className="relative mt-6 md:mt-0">
                    <ImagePlaceholderDark src="/images/climateguardpro img/salute-cucina.png" label="FOTO: KUCHYNSKÉ VÝPARY A PE= ZACHYTENÝ FILTROM" height="h-[300px] md:h-[500px]" />
                 </div>
              </ScrollReveal>
           </div>
        </section>
           ...
           <div className="max-w-7xl mx-auto relative z-10">
              ...
              <ScrollReveal className="grid md:grid-cols-2 gap-8 md:gap-20 items-center">
                 <div className="order-2 md:order-1 relative mt-6 md:mt-0">
                    <ImagePlaceholderDark src="/images/climateguardpro img/app-risparmio.png" label="FOTO: AUTO RE}IM A APLIKÁCIA" height="h-[300px] md:h-[500px]" />
                 </div>
                 <div className="order-1 md:order-2 relative">
                    ...
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-6 md:mb-8 leading-tight drop-shadow-lg">
                       Auto re~im: <span className="text-green-500">Platí sám za seba.</span>
                    </h2>
                    <p className="text-gray-200 text-lg md:text-xl leading-relaxed mb-8 font-light">
                       ClimateGuard má <strong className="text-green-400">"laserové senzory"</strong>, ktoré analyzujú vzduch.
                       <br/><br/>
                       <span className="flex items-start gap-3 mb-4">
                         ...
                         <span><strong>Vidí apinu:</strong> Ak varíte alebo je dym, zrýchli istenie.</span>
                       </span>
                       <span className="flex items-start gap-3">
                         ...
                         <span><strong>Cíti chlad:</strong> Hne ako dosiahne 26°C, zní~i výkon na minimum.</span>
                       </span>
                       <br/><br/>
                       Neplytváva ani 1 watt energie. Preto je <strong className="text-white bg-green-900/40 px-2 py-0.5 rounded border border-green-500/30">energetická trieda AAA+</strong>.
                    </p>
                    <button onClick={scrollToForm} className="bg-white/5 hover:bg-white/10 text-white border-2 border-green-500/50 hover:border-green-500 px-6 py-5 md:px-8 md:py-6 rounded-2xl flex items-center gap-4 transition-all w-full md:w-auto justify-center font-bold text-lg md:text-xl shadow-[0_0_20px_rgba(34,197,94,0.2)]">
                       Chcem zní~ie faktúru na polovicu
        ...
        <section className="py-12 md:py-24 px-4 md:px-6 bg-void-900 border-t border-white/5">
           <div className="max-w-7xl mx-auto">
              <ScrollReveal className="text-center mb-10 md:mb-12">
                 <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-4">Úplný komfort</h2>
                 ...
                 <ScrollReveal delay={0} className="md:col-span-2 h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 group hover:border-neon-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="flex-1 relative z-10">
                         ...
                         <h3 className="text-2xl font-bold text-white mb-2">Ovládanie cez aplikáciu</h3>
                         <p className="text-gray-400 text-lg">
                            Nájdite teplý domov po návrate. Zapnite, vypnite a naprogramujte vaetko z telefónu, kdeko>vek ste. Kompatibilné s hlasovými príkazmi.
                         </p>
                      </div>
                 ...
                 <ScrollReveal delay={150} className="h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 group hover:border-purple-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                         ...
                         <h3 className="text-xl font-bold text-white mb-2">Údr~ba za 60 sekúnd</h3>
                         <p className="text-gray-400 text-lg">
                            Aplikácia a displej vás upozornia, kedy vymenie filter. Vymení sa jedným kliknutím, bez nástrojov. Ve>mi jednoduché.
                         </p>
                      </div>
                   </div>
                 </ScrollReveal>
                 ...
                 <ScrollReveal delay={300} className="h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 group hover:border-blue-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                         ...
                         <h3 className="text-xl font-bold text-white mb-2">Re~im "Rozptýlený"</h3>
                         <p className="text-gray-400 text-lg">
                            Chcete istie bez pocitu vzduchu na tele? Prúd sa presmeruje dozadu. Nevidite>ný a tichý komfort.
                         </p>
                      </div>
                   </div>
                 </ScrollReveal>
                 ...
                 <ScrollReveal delay={450} className="md:col-span-2 h-full">
                   <div className="bg-void-950 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8 group hover:border-green-500/50 transition-all h-full relative overflow-hidden">
                      ...
                      <div className="flex-1 relative z-10">
                         ...
                         <h3 className="text-2xl font-bold text-white mb-2">Noný re~im Ultra-Silent</h3>
                         <p className="text-gray-400 text-lg">
                            Spíte pokojne. Displej sa vypne, hlunose klesne pod 25dB a vzduch sa neustále istí poas spánku.
                         </p>
                      </div>
                      <div className="w-full md:w-1/3">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 max-w-4xl mx-auto overflow-x-clip overflow-y-visible text-white">
         <ScrollReveal className="text-center mb-10 md:mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 font-display">Pochybnosti? Odpovie vám expert</h3>
            <p className="text-base md:text-lg text-gray-400">Kliknite na otázky pre okam~itú odpove.</p>
         </ScrollReveal>
      ...
      <section id="order-form" className="py-12 md:py-24 px-4 md:px-6 bg-[#050508] border-t border-white/10 pb-40 md:pb-24 overflow-x-clip overflow-y-visible relative text-white">
        ...
        <div className="max-w-2xl mx-auto">
          <ScrollReveal className="text-center mb-10 md:mb-12">
             ...
             <p className="text-base md:text-lg text-gray-400">Rýchle doruenie za 24/48h v cene.</p>
          </ScrollReveal>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex flex-row md:flex-col items-center gap-4 text-left md:text-center">
                  ...
                  <div>
                     ...
                     <p className="text-gray-400 text-xs">Zadajte údaje ni~aie.</p>
                  </div>
               </div>
               <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex flex-row md:flex-col items-center gap-4 text-left md:text-center relative">
                  ...
                  <div>
                     ...
                     <p className="text-gray-400 text-xs">Zavoláme vám na potvrdenie.</p>
                  </div>
               </div>
               <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex flex-row md:flex-col items-center gap-4 text-left md:text-center relative">
                  <div className="hidden md:block absolute -left-2 top-1/2 -translate-y-1/2 w-4 border-t-2 border-dashed border-gray-600"></div>
                  ...
                  <div>
                     ...
                     <p className="text-gray-400 text-xs">V hotovosti kuriérovi.</p>
                  </div>
               </div>
             </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={200} className="bg-void-900/80 border border-white/10 p-6 md:p-10 rounded-3xl shadow-2xl relative overflow-hidden backdrop-blur-xl">
             ...
             {submitted ? (
               <div className="text-center py-10 md:py-20 flex flex-col items-center">
                  ...
                  <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-md mx-auto">akujeme! Vaaa objednávka bola prijatá. Náa operátor vás bude kontaktovae cez WhatsApp alebo telefón do 2 hodín na potvrdenie doruenia.</p>
                  <button onClick={() => window.location.reload()} className="text-neon-500 font-bold underline text-xl">Späe do obchodu</button>
               </div>
             ) : (
               <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                     ...
                     <ul className="space-y-3">
                        ...
                        <li className="flex items-center gap-3 text-white text-base md:text-lg">
                           <CheckCircle2 className="text-green-500 w-5 h-5 md:w-6 md:h-6 shrink-0"/>
                           <span>Inteligentný dia>kový ovláda <span className="text-gray-500 text-xs ml-1">(Súase balenia)</span></span>
                        </li>
                        <li className="flex items-center gap-3 text-white text-base md:text-lg bg-neon-500/10 p-2 -mx-2 rounded-lg border border-neon-500/20">
                           ...
                           <span className="font-bold">1x Náhradný filter HEPA <span className="text-neon-500 text-xs font-black ml-2 bg-neon-500/20 px-1.5 py-0.5 rounded border border-neon-500/50 uppercase">Darek</span></span>
                        </li>
                     </ul>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <Input name="fullName" placeholder="Napr.: Ján Novák" onChange={handleInputChange} className="pl-12" />
                        </div>
                    </div>

                    <div>
                       <label className="block text-gray-400 text-xs font-bold uppercase mb-2 ml-1">Úplná adresa (Ulica, Mesto, PS)</label>
                       <div className="relative">
                    ...
                    <div>
                       <label className="flex justify-between items-center text-gray-400 text-xs font-bold uppercase mb-2 ml-1">
                          <span>Telefónne íslo</span>
                          <span className="text-neon-500">Pre potvrdenie objednávky</span>
                       </label>
                       <div className="relative">
                       ...
                       <p className="text-[10px] text-gray-500 mt-1 ml-1 flex items-center gap-1">
                          <CheckCircle2 className="w-3 h-3 text-green-500" /> Dôle~ité: odpovedzte na hovor pre aktiváciu doruenia.
                       </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/20 p-5 rounded-2xl flex gap-4 items-start">
                     ...
                     <div className="text-sm md:text-base text-gray-300">
                        ...
                        Nepýtame si kartu. Zaplatíte <span className="text-white font-bold underline">69,99¬</span> priamo kuriérovi v hotovosti.
                     </div>
                  </div>
                  ...
                  <button type="submit" className="w-full bg-neon-500 hover:bg-neon-400 text-white font-display font-bold py-5 md:py-6 rounded-2xl text-xl md:text-2xl shadow-[0_0_40px_rgba(255,77,0,0.4)] transition-all mt-6 flex items-center justify-center gap-4 animate-pulse-neon group relative overflow-hidden">
                     <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full animate-shimmer"></div>
                     <span className="relative z-10">POTVRDId OBJEDNÁVKU</span>
        ...
        <div className="p-3">
           <button onClick={scrollToForm} className="w-full bg-neon-500 hover:bg-neon-400 text-white rounded-xl py-3.5 px-5 flex justify-between items-center shadow-[0_0_20px_rgba(255,77,0,0.4)] group active:scale-95 transition-transform relative overflow-hidden">
              ...
              <div className="flex flex-col items-start leading-none relative z-10">
                 ...
                 <span className="text-[10px] opacity-90 flex items-center gap-1 font-medium mt-0.5"><Wallet className="w-3 h-3" /> Platíte kuriérovi</span>
              </div>
