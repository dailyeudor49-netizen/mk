    ...
    <section className="py-12 px-4 bg-white border-t border-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-gray-500 font-medium">Založeno na více než 1 500 spokojených zákaznících v České republice</p>
        </div>
            ...
            <div key={review.id} className="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm relative hover:shadow-md transition">
              ...
              {review.hasImage && review.imageUrl && (
                  <div className="mt-3 border-t pt-3">
                     <img src={review.imageUrl} alt="Foto recensione" className="w-16 h-16 object-cover rounded border border-gray-300" />
                  </div>
              )}
            </div>
          ))}
        ...
        {!showAll && (
            <div className="mt-8 text-center">
                ...
                >
                    {isLoading ? (
                        <>
                            <Loader className="animate-spin" size={20} /> Načítání...
                        </>
                    ) : (
