...
import { BUNDLE_ITEMS, CURRENCY } from '../lib/constants';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-2 mb-8 flex-wrap px-2">
            ...
            <p className="text-center text-base md:text-lg font-bold text-red-600 uppercase">
                Mega Zestaw Akcesoriów (99 {CURRENCY}) <span className="bg-red-600 text-white px-2 py-0.5 rounded text-sm ml-1">GRATIS</span>
            </p>
        </div>
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg border-2 border-green-500 relative overflow-hidden">
            ...
            <div className="mb-8 flex justify-center mt-6 md:mt-0">
                 <img src="/images/robotcleanprox imggif/ROBOTCLEANPROX IMG LANDING/1.png" alt="Zawartość zestawu" className="rounded-lg opacity-90 hover:opacity-100 transition w-full max-w-md" />
            </div>
            ...
            <div className="mt-8 text-center">
                <p className="text-gray-500 text-sm">Nie będziesz musiał kupować części zamiennych przez co najmniej 12 miesięcy.</p>
            </div>
        </div>
      </div>
    </section>
