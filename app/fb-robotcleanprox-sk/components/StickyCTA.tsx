      ...
      <div className="max-w-4xl mx-auto px-4 py-2 md:py-3 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="flex flex-col">
            <span className="text-[10px] md:text-xs text-gray-400 line-through">Cenník {CURRENCY}{PRICE_LIST}</span>
            <span className="text-xl md:text-2xl font-black text-red-600 leading-none">{CURRENCY}{PRICE_PROMO.toString().replace('.', ',')}</span>
          </div>
