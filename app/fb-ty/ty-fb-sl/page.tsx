...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (!purchaseTracked) {
      const alreadyTracked = sessionStorage.getItem('fb_purchase_tracked_sl');
      if (!alreadyTracked) {
        ...
        const trackPurchase = () => {
          ...
          // Usa i dati salvati dalla landing o fallback a valori di default SL
          const eventData = storedEventData || {
            value: 59,
            currency: 'EUR',
            content_name: 'Product SL',
            content_type: 'product' as const,
            content_ids: 'product-sl'
          };

          console.log('[TY-SL] Using event data:', eventData);
          trackPurchaseEvent(userData, eventData);

          sessionStorage.setItem('fb_purchase_tracked_sl', 'true');
          setPurchaseTracked(true);
          console.log('[TY-SL] Facebook Purchase tracked');
        };
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <p style={{
          ...
          Vaše naročilo je bilo uspešno prejeto.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Plačilo ob prevzemu</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Plačali boste z gotovino kurirju</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Brezplačna dostava</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Dostava v 2-3 delovnih dneh</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>30 dni za vračilo</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Vračilo denarja, če niste zadovoljni</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>2 leti garancije</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Na vse izdelke</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>Vračilo lahko zahtevate v 30 dneh, če z izdelkom niste zadovoljni</div>
        </div>
