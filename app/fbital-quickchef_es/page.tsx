    ...
    <div className="sticky top-0 z-50 w-full bg-red-700 text-white text-xs sm:text-sm font-bold shadow-md">
      <div className="max-w-6xl mx-auto px-2 py-2 flex flex-wrap justify-center items-center gap-x-4 gap-y-1 text-center">
        ...
        <div className="hidden md:flex items-center gap-1">
          <Phone size={14} /> ATENCION AL CLIENTE EN ESPANOL
        </div>
      </div>
    </div>
  );
...
const benefits = [
  <span key="1"><strong className="text-red-700">NOVEDAD EXCLUSIVA:</strong> Dosificacion Automatica de ingredientes (lo hace todo solo)</span>,
  <span key="2"><strong className="text-gray-900">45 Funciones en 1:</strong> el robot mas completo del mercado</span>,
  <span key="3">Pantalla tactil <strong className="text-gray-900">7" SoftScreen</strong> grande y clara - te guia paso a paso</span>,
  <span key="4">App con <strong className="text-gray-900">1000+ recetas</strong> - elige y sigue como un tutorial</span>,
  <span key="5">Funcion <strong className="text-gray-900">"Que tengo en la nevera?"</strong> - ahorras en la compra</span>,
  <span key="6"><strong className="text-gray-900">Bascula integrada</strong> precisa al gramo - adios a las dosis "a ojo"</span>,
  <span key="7">Jarra <strong className="text-gray-900">Ceramica Antiadherente</strong> - nada se quema, se limpia en un momento</span>,
  <span key="8">Coccion hasta <strong className="text-gray-900">180C</strong> + Sofrito real</span>,
    ...
    <section className="bg-white pt-6 pb-12 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
          <span className="text-red-600 block mb-2 text-xl md:text-2xl uppercase tracking-wide">Cansado de perder tiempo en la cocina?</span>
          Descubre el Primer Robot que <span className="bg-yellow-200 px-2">Anade los Ingredientes Solo.</span>
        </h1>

        <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-2xl mx-auto leading-relaxed">
          Olvida las ollas y el estres. Pon todo en el dispensador, elige la receta en la pantalla y <strong className="text-gray-900">el cocina por ti mientras tu descansas.</strong>
          <br className="my-2"/>
        ...
        <div className="relative mb-8 rounded-xl overflow-hidden shadow-2xl border-4 border-gray-100 max-w-xl mx-auto group bg-gray-100">
           <div className="relative aspect-square w-full">
             <img
               ...
               alt={`Robot de cocina slide ${currentSlide + 1}`}
        ...
        <div className="bg-white border-4 border-red-600 p-6 rounded-xl max-w-2xl mx-auto mb-8 relative shadow-xl transform transition-transform hover:scale-[1.01]">
          ...
          <div className="flex flex-col items-center justify-center mb-6 mt-6">
             ...
             <span className="bg-green-100 text-green-800 font-bold px-3 py-1 rounded-full text-sm mt-2 border border-green-200">-50% DESCUENTO</span>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-100 text-left space-y-4">
             ...
             <div className="flex items-center gap-3 border-b border-gray-200 pb-3 last:border-0 last:pb-0">
               ...
               <div>
                 ...
                 <p className="text-sm text-gray-500 mt-1">Sin adelanto, en efectivo al repartidor</p>
               </div>
             </div>
             ...
             <div className="flex items-center gap-3">
               ...
               <div>
                 <p className="font-bold text-gray-900 leading-none text-lg">Garantia 2 Anos</p>
                 <p className="text-sm text-gray-500 mt-1">Asistencia tecnica incluida</p>
               </div>
             </div>
          </div>

          <Button onClick={scrollToForm} fullWidth pulse size="xl" subtext="Sin tarjeta de credito requerida">
        ...
        <div className="bg-red-50 border border-red-100 rounded-xl p-6 md:p-8 shadow-sm">
          ...
          <ul className="space-y-5 mb-8">
            <li className="flex items-start gap-3">
              ...
              <span className="text-lg text-gray-800">Abres la nevera y <strong className="text-red-700">no sabes que cocinar.</strong></span>
            </li>
            <li className="flex items-start gap-3">
              <div className="bg-red-100 p-1 rounded-full shrink-0 mt-1">
                <X className="text-red-600" size={22} strokeWidth={3} />
            ...
            <li className="flex items-start gap-3">
              ...
              <span className="text-lg text-gray-800">Acabas <strong>pidiendo comida basura</strong> y gastando de mas.</span>
            </li>
          </ul>
          ...
          <div className="text-center bg-white p-6 rounded-lg border border-gray-100 shadow-md">
            ...
            <Button onClick={scrollToForm} variant="primary" size="lg" className="mx-auto">
              SI, LO QUIERO - PAGO CONTRA REEMBOLSO
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md border-b-4 border-green-500 relative overflow-hidden">
            ...
            <p className="text-gray-600">Introduce los ingredientes en los <strong className="text-gray-900">6 compartimentos</strong>. No tienes que pesarlos antes, se encarga la bascula.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md border-b-4 border-green-500 relative overflow-hidden">
            ...
            <p className="text-gray-600">El dosifica los ingredientes <strong className="text-gray-900">en el momento justo</strong>, cocina y remueve. Te avisa cuando esta listo!</p>
          </div>
        </div>
...
const features: FeatureBox[] = [
  ...
  },
  {
    ...
    description: "Jarra Unique revestida en ceramica: nunca se pega y se limpia con una pasada.",
    imageUrl: "/images/quickchef img/Ceramica Antiaderente.png"
  },
  {
    id: 5,
    title: "45 Funciones en 1",
    description: "Tritura, amasa, cuece al vapor, fermenta, slow cooking, yogur... sustituye 10 electrodomesticos.",
    imageUrl: "/images/quickchef img/45 Funzioni in 1.png"
  },
  {
    id: 6,
    title: "Resultados de Chef",
    description: "Cremas aterciopeladas, masas para pizza perfectas, salsas densas. Todo en automatico.",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 text-center">
          <Button onClick={scrollToForm} variant="primary" size="lg">
            CONSIGUELO AHORA - PAGAS A LA ENTREGA
          </Button>
        </div>
      </div>
    </section>
          ...
          <div className="w-full md:w-1/2">
            ...
            <ul className="space-y-4">
              {[
                ...
                <span key="5">Vaporera XL a 2 niveles</span>,
                ...
                <span key="8"><strong className="text-gray-900">Garantia 2 Anos</strong></span>
              ].map((item, idx) => (
...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.location.href = '/fb-ty/ty-fb-es';
    } catch (error) {
    ...
    <section id="order-form" className="py-12 px-4 bg-red-50 border-t-4 border-red-600 scroll-mt-20">
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="bg-red-600 p-6 text-center text-white relative overflow-hidden">
          ...
          <p className="font-medium opacity-90 relative z-10">Rellena para recibir la oferta 50% descuento</p>
        </div>
        ...
        <div className="bg-yellow-100 p-3 text-center border-b border-yellow-200">
          <p className="text-red-700 font-bold text-sm animate-pulse">
            Alta demanda: solo quedan 7 unidades a este precio!
          </p>
        </div>
        ...
        <div className="p-5 md:p-8">
          <div className="flex justify-between items-center mb-6 pb-6 border-b border-gray-200 bg-gray-50 p-4 rounded-lg">
            <div>
              <p className="text-gray-500 line-through text-sm">Precio de Lista: 178 EUR</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-1 text-sm uppercase tracking-wide">Direccion Completa (Calle, Numero, Ciudad, CP) *</label>
              <textarea
                name="fullAddress"
                required
                ...
                placeholder="Ej: Calle Mayor 10, 28001 Madrid"
            ...
            <div className="bg-gray-50 p-4 rounded border border-gray-200 mt-4 cursor-pointer hover:bg-gray-100 transition-colors">
               <label className="flex items-start gap-3 cursor-pointer pointer-events-none">
                 ...
                 <div>
                   <span className="block font-bold text-gray-800">Pago a la Entrega (Efectivo)</span>
                   <span className="block text-xs text-gray-500">Pagas directamente al repartidor cuando llegue el paquete. Sin riesgo.</span>
                 </div>
               </label>
            </div>
...
// 13. Faq Component
const faqs: FaqItem[] = [
  { question: "Puedo pagar a la entrega?", answer: "Si, por supuesto. Pagas en efectivo directamente al repartidor cuando te entregue el paquete. No se requiere pago anticipado." },
  { question: "Cuanto tarda en llegar?", answer: "Enviamos con transporte urgente en 24/48 horas laborables a toda Espana." },
  ...
  { question: "Se limpia facilmente?", answer: "Si, tiene funcion de autolimpieza y la jarra tiene un revestimiento ceramico antiadherente que se lava con un simple pano." },
  ...
  { question: "Y si no me va bien?", answer: "Tienes la garantia de 2 anos. Ademas, ofrecemos atencion al cliente en espanol dedicada para cualquier duda o problema." }
];
    ...
    <section className="py-6 px-4 bg-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-gray-400 text-sm">
          QuickChef es una marca distribuida exclusivamente por <strong className="text-white">Ionizi</strong> - Distribuidor Oficial Autorizado
        </p>
      </div>
    </section>
  );
