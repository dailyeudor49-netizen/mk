        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden border-2 border-gray-100">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                [<span key="1">Dozator automat <br/><span className="text-xs font-normal text-gray-500">(Adauga ingredientele singur)</span></span>, true, "Nu are (Faci tu)"],
                [<span key="2">Total functii</span>, "45 (Cel mai complet)", "Aprox. 12-20"],
                [<span key="3">Ecran tactil</span>, "7\" SoftScreen", "Mic sau absent"],
                [<span key="4">Aplicatie + Goleste-frigiderul</span>, "Da (1000+ Retete)", "Putine retete"],
                [<span key="5">Material vas</span>, "Ceramic antiaderent", "Otel (Se lipeste)"],
                [<span key="6">Capacitate</span>, "3,3L (Pentru familie)", "2,2L (Mica)"],
                [<span key="7">Curatare</span>, "Auto-curatare + Masina de spalat", "Obositoare manual"],
...
const reviewsList: Review[] = [
  { id: 1, name: "Maria", age: 57, location: "Bucuresti", stars: 5, text: "Nu am fost niciodata buna la gatit... cu asta totul iese perfect. Ecranul imi arata ce sa fac, e foarte practic." },
  { id: 2, name: "Andrei", age: 63, location: "Cluj-Napoca", stars: 5, text: "Gatitul devenise plictisitor. Acum pun totul si el gateste. Sa curat e mult mai simplu." },
  { id: 3, name: "Elena", age: 41, location: "Timisoara", stars: 5, text: "Lucrez si nu am timp. Asta ma salveaza seara. Chiar si aluaturile si sosurile ies perfecte." },
