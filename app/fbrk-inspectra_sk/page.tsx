...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-[#0f766e] selection:text-white">
      ...
      <img src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=614&uid=019855d0-397a-72ee-8df5-c5026966105a&lp=614" style={{width:'1px',height:'1px',display:'none'}} alt="" />
      <TopBar />
