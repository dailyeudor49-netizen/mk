  ...
  return (
    <div className="overflow-hidden rounded-xl border-2 border-gray-200 shadow-lg my-8 bg-white">
      ...
      <div className="grid grid-cols-3 bg-gray-50 border-b border-gray-200 text-xs md:text-sm">
        <div className="p-3 font-bold text-gray-400 flex items-center justify-center">CECHA</div>
      ...
      <div className="grid grid-cols-3 border-b border-gray-100">
        ...
        <div className="p-3 bg-green-50/50 flex flex-col items-center justify-center border-x border-green-100">
          ...
          <span className="text-[10px] md:text-xs font-bold text-green-800 uppercase text-center">Realne 8cm</span>
        </div>
        <div className="p-3 flex flex-col items-center justify-center opacity-50">
          <XCircle className="w-6 h-6 text-red-400 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-gray-500 uppercase text-center">Blokują Się</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 border-b border-gray-100">
        ...
        <div className="p-3 bg-green-50/50 flex flex-col items-center justify-center border-x border-green-100">
          <CheckCircle2 className="w-6 h-6 text-green-600 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-green-800 uppercase text-center">2x (8 Godzin)</span>
        </div>
        <div className="p-3 flex flex-col items-center justify-center opacity-50">
          <Minus className="w-6 h-6 text-gray-400 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-gray-500 uppercase text-center">Tylko 1</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 border-b border-gray-100">
        ...
        <div className="p-3 bg-green-50/50 flex flex-col items-center justify-center border-x border-green-100">
          <CheckCircle2 className="w-6 h-6 text-green-600 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-green-800 uppercase text-center">Wart 400zł</span>
        </div>
        <div className="p-3 flex flex-col items-center justify-center opacity-50">
          <XCircle className="w-6 h-6 text-red-400 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-gray-500 uppercase text-center">Żadnego</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="p-3 bg-green-50/50 flex flex-col items-center justify-center border-x border-green-100">
          <CheckCircle2 className="w-6 h-6 text-green-600 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-green-800 uppercase text-center">2 Lata</span>
        </div>
        <div className="p-3 flex flex-col items-center justify-center opacity-50">
          <XCircle className="w-6 h-6 text-red-400 mb-1" />
          <span className="text-[10px] md:text-xs font-bold text-gray-500 uppercase text-center">Brak</span>
        </div>
      </div>
    </div>
  );
