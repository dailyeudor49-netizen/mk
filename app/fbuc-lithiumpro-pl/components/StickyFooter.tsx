    ...
    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-[0_-4px_10px_rgba(0,0,0,0.15)] z-50 p-3 md:hidden pb-safe">
      <div className="flex items-center justify-between gap-3 max-w-lg mx-auto">
        <div className="flex flex-col shrink-0">
          <span className="text-[10px] text-gray-500 line-through font-medium">Cena: 558 zł</span>
          <span className="text-2xl font-black text-gray-900 leading-none">{PRICE_PROMO} {CURRENCY}</span>
        </div>
        <button
        ...
        >
          ...
          <span className="text-[10px] uppercase font-bold text-green-100 flex items-center gap-1">
             <Wallet className="w-3 h-3" /> Płatność przy odbiorze
          </span>
        </button>
      </div>
    </div>
