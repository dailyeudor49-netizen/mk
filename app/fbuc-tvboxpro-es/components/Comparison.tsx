...
const comparisonData = [
    ...
    {
        feature: "¿Funciona en TVs viejos?",
        us: { text: "SÍ, INCLUSO EN ANTIGUOS", sub: "Solo necesita HDMI", highlight: false },
        them: { text: "No", sub: "Tienes que comprar uno nuevo", highlight: false }
    },
    {
        feature: "Instalación",
        us: { text: "30 Segundos", sub: "Lo haces tú mismo", highlight: false },
        them: { text: "Complicada", sub: "Facturas, WiFi, Canales...", highlight: false }
    },
    {
        feature: "Portabilidad",
        us: { text: "SÍ, DONDE QUIERAS", sub: "Casa de campo, Hotel, Apartamento", highlight: false },
        them: { text: "NO", sub: "Se queda en un sitio", highlight: false }
    },
    {
        feature: "¿Videojuegos?",
        us: { text: "INCLUIDO", sub: "+ Mando de Regalo", highlight: true },
        them: { text: "APARTE", sub: "Necesitas consola", highlight: false }
    },
    {
        feature: "Vida útil",
        us: { text: "AÑOS", sub: "Solo actualizas el box", highlight: false },
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-8 text-lg">
          Mira cuánto ahorras comparado con comprar un Smart TV nuevo.
        </p>
