    ...
    <section className="bg-white pb-8">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-6">
        ...
        <p className="text-center text-gray-700 text-lg md:text-xl font-medium mb-6 leading-relaxed">
          El primer Box "Todo en uno" que trae <span className="font-bold underline">Películas, Deporte en vivo y Juegos</span> a cualquier televisor en 30 segundos. <span className="bg-yellow-100 px-1">Tan fácil de usar como el mando a distancia.</span>
        </p>
        ...
        <div className="flex justify-center items-center gap-2 mb-6">
          ...
          <span className="font-bold text-gray-700 underline decoration-green-500 decoration-2">12.450 españoles ya lo usan</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start border-4 border-gray-100 p-4 rounded-xl bg-gray-50 shadow-xl">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-4 mb-6 text-left w-full">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Cine en casa:</span> Todas las apps (Netflix, YouTube, HBO) <span className="font-bold">listas para usar</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Deporte sin cortes:</span> Ve los partidos en calidad 4K <span className="font-bold">sin interrupciones</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Tu TV es una Consola:</span> Ahorra en PlayStation. Mando para juegos incluido.
                </span>
              </li>
            </ul>
            ...
            >
              QUIERO PEDIRLO
              <span className="block text-sm font-normal mt-1 opacity-90 text-yellow-100">Pago contra reembolso (A la entrega)</span>
            </button>
            ...
            <div className="w-full grid grid-cols-3 gap-2 py-3 border-t border-gray-200">
                ...
                <div className="flex flex-col items-center justify-start text-center border-l border-r border-gray-200">
                    ...
                    <span className="text-[10px] md:text-xs font-bold text-gray-700 leading-tight">ENTREGA<br/>24/48 HORAS</span>
                </div>
                <div className="flex flex-col items-center justify-start text-center">
