...
// Network config for ES (Facebook Uncapped)
      ...
      return (
          <section id="order-form" className="py-16 px-4 bg-green-50 min-h-[50vh] flex items-center justify-center">
              <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border-4 border-green-500">
                  ...
                  <p className="text-gray-600">Nuestro agente te contactará pronto al número <span className="font-bold">{formState.phone}</span> para coordinar la entrega.</p>
                  <div className="mt-6 bg-yellow-100 p-4 rounded-lg border border-yellow-300">
                    <p className="font-bold text-gray-800 uppercase text-sm mb-1">Importe a pagar al repartidor:</p>
    ...
    <section id="order-form" className="py-12 px-4 bg-gray-200">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-300">
        ...
        <div className="bg-red-600 text-white p-6 text-center">
          ...
          <p className="text-lg font-medium">Rellena los datos para reservar la promoción</p>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 p-4 rounded-lg mb-8 shadow-sm">
            ...
            <div className="flex justify-between items-center mt-3 pt-3 border-t-2 border-yellow-200 text-2xl font-black text-red-600">
              <span>TOTAL (Contra reembolso):</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
              />
              <p className="text-sm text-gray-500 mt-1 font-medium bg-blue-50 p-2 rounded text-blue-800">ℹ️ Importante: El repartidor te llamará a este número antes de la entrega.</p>
            </div>

            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Dirección de entrega <span className="text-red-500">*</span></label>
              <textarea
                name="address"
                required
                placeholder="Ciudad, Calle, Número, Piso..."
                rows={3}
            ...
            <div className="bg-gray-100 p-4 rounded-lg flex items-center gap-3 text-sm text-gray-600 border border-gray-200">
               ...
               <span>Sin riesgo: pagas en efectivo solo cuando recibas el paquete.</span>
            </div>
