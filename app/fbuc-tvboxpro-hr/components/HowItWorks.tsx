    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          INSTALACIJA? <br/>
          <span className="text-green-600">KAO DJEČJA IGRA</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">SPOJI</h3>
            <p className="text-gray-600 px-4">
              Uključite HDMI kabel u televizor. Nije potrebno zvati tehničara, samo pronađite slobodan ulaz na poleđini TV-a.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">POVEŽI</h3>
            <p className="text-gray-600 px-4">
              Uključite uređaj i povežite ga s kućnim WiFi-em (ili internetom s mobitela). Radi sa svim operaterima.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">GLEDAJ</h3>
            <p className="text-gray-600 px-4">
              Gotovo! Imate pristup tisućama kanala, filmova, serija i igara. Bez ugovora i bez stresa.
            </p>
          </div>
