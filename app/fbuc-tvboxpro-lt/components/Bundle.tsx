      ...
      <div className="max-w-4xl mx-auto border-4 border-yellow-400 rounded-2xl p-6 relative bg-white shadow-xl">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-8 items-center justify-center">
            ...
            <div className="flex-1 text-center w-full">
                ...
                <p className="text-gray-500 line-through font-bold">Vertė 118,00 {CURRENCY}</p>
            </div>
            ...
            <div className="flex-1 text-center w-full">
                <img src="/images/tvboxpro-4k/12.png" alt="Balso Pultelis" className="w-48 h-48 mx-auto rounded-xl shadow-lg mb-4 object-contain bg-white border border-gray-200"/>
                <p className="font-bold text-gray-800 text-lg uppercase mb-1">Balso Pultelis</p>
                <div className="inline-block bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-bold">ĮTRAUKTA</div>
            </div>
            ...
            <div className="flex-1 text-center w-full relative">
                ...
                <img src="/images/tvboxpro-4k/11.png" alt="Belaidis Pultelis" className="w-48 h-48 mx-auto rounded-xl shadow-lg mb-4 object-contain bg-white border-4 border-yellow-400"/>
                <p className="font-black text-gray-900 text-lg uppercase mb-1">Belaidis Pultelis</p>
                <p className="text-green-600 font-black text-lg bg-green-100 inline-block px-2 rounded">NEMOKAMAI (Vertė 25 {CURRENCY})</p>
            </div>
        </div>
      </div>
    </section>
