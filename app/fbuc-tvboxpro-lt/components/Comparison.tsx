...
const comparisonData = [
    {
        ...
        them: { text: "Daugiau nei 500 €", sub: "Naujo TV kaina", highlight: false }
    },
    {
        feature: "Ar veikia su senais TV?",
        us: { text: "TAIP, NET SU SENAIS", sub: "Reikia tik HDMI", highlight: false },
        them: { text: "Ne", sub: "Reikia pirkti naują", highlight: false }
    },
    {
        feature: "Įdiegimas",
        us: { text: "30 Sekundžių", sub: "Padarykite patys", highlight: false },
        them: { text: "Sudėtingas", sub: "Sąskaitos, WiFi, Kanalai...", highlight: false }
    },
    {
        feature: "Mobilumas",
        us: { text: "TAIP, BET KUR", sub: "Sodyba, Viešbutis, Apartamentai", highlight: false },
        them: { text: "NE", sub: "Stovi vienoje vietoje", highlight: false }
    },
    {
        feature: "Vaizdo žaidimai?",
        us: { text: "KOMPLEKTE", sub: "+ Pultelis Dovanų", highlight: true },
        them: { text: "ATSKIRAI", sub: "Reikia konsolės", highlight: false }
    },
    {
        feature: "Tarnavimo laikas",
        us: { text: "METAMS", sub: "Atnaujinate tik box", highlight: false },
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-2 uppercase text-gray-900 leading-tight">
          NEMESKITE SENO TELEVIZORIAUS!
        </h2>
        <p className="text-center text-gray-600 mb-8 text-lg">
          Pažiūrėkite, kiek sutaupote palyginus su naujo Smart TV pirkimu.
        </p>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Rezultatas: Box laimi 6:0 kainos ir kokybės santykiu.
                </p>
            </div>
        </div>
