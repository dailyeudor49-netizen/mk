        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-gray-600 px-4">
              Įkiškite HDMI kabelį į televizorių. Nereikia kviesti techniko, tiesiog raskite laisvą jungtį TV gale.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">SUJUNKITE</h3>
            <p className="text-gray-600 px-4">
