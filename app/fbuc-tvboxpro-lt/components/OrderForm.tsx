...
// Network config for LT (Facebook Uncapped)
      ...
      return (
          <section id="order-form" className="py-16 px-4 bg-green-50 min-h-[50vh] flex items-center justify-center">
              <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border-4 border-green-500">
                  ...
                  <p className="text-gray-600">Mūsų atstovas netrukus susisieks su jumis telefonu <span className="font-bold">{formState.phone}</span> dėl pristatymo.</p>
    ...
    <section id="order-form" className="py-12 px-4 bg-gray-200">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-300">
        ...
        <div className="bg-red-600 text-white p-6 text-center">
          ...
          <p className="text-lg font-medium">Užpildykite žemiau, kad rezervuotumėte akciją</p>
          ...
          <div className="flex items-center justify-center gap-2 mt-4 bg-red-700 py-2 rounded-lg border border-red-500">
            ...
            <span className="font-bold text-xl">Pasiūlymas baigiasi: {formatTime(timeLeft)}</span>
          </div>
        </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="bg-yellow-50 border-2 border-yellow-400 p-4 rounded-lg mb-8 shadow-sm">
            <h3 className="font-bold text-gray-800 text-lg mb-2 border-b border-yellow-200 pb-2">Užsakymo santrauka:</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Pristatymo adresas <span className="text-red-500">*</span></label>
              <textarea
                name="address"
                required
                placeholder="Miestas, Gatvė, Namo numeris, Butas..."
                rows={3}
            ...
            <div className="bg-gray-100 p-4 rounded-lg flex items-center gap-3 text-sm text-gray-600 border border-gray-200">
               ...
               <span>Be rizikos: mokate grynais tik kai gausite siuntą.</span>
            </div>
