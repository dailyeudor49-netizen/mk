...
const comparisonData = [
    {
        feature: "Całkowity koszt",
        us: { text: `Tylko ${PRICE_PROMO} ${CURRENCY}`, sub: "Płatność jednorazowa", highlight: true },
        them: { text: "Ponad 2000 zł", sub: "Koszt nowego TV", highlight: false }
    },
    {
        feature: "Działa na starych TV?",
        us: { text: "TAK, NAWET 10-LETNICH", sub: "Wystarczy wejście HDMI", highlight: false },
        them: { text: "Nie", sub: "Musisz kupić nowy", highlight: false }
    },
    {
        feature: "Instalacja",
        us: { text: "30 Sekund", sub: "Zrobisz to sam", highlight: false },
        them: { text: "Skomplikowana", sub: "Konta, WiFi, Kanały...", highlight: false }
    },
    {
        feature: "Mobilność",
        us: { text: "TAK, WSZĘDZIE", sub: "Wakacje, Hotel, Działka", highlight: false },
        them: { text: "NIE", sub: "Stoi w miejscu", highlight: false }
    },
    {
        feature: "Gry wideo?",
        us: { text: "W ZESTAWIE", sub: "+ Pad Gratis", highlight: true },
        them: { text: "OSOBNO", sub: "Trzeba kupić konsolę", highlight: false }
    },
    {
        feature: "Trwałość",
        us: { text: "NA LATA", sub: "Aktualizujesz tylko box", highlight: false },
        them: { text: "STARZEJE SIĘ", sub: "TV po latach muli", highlight: false }
    }
];
    ...
    <section className="bg-white py-12 px-4 border-t-8 border-gray-100">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-2 uppercase text-gray-900 leading-tight">
          NIE WYRZUCAJ STAREGO TELEWIZORA!
        </h2>
        <p className="text-center text-gray-600 mb-8 text-lg">
          Zobacz, ile zyskujesz w porównaniu do zakupu nowego Smart TV.
        </p>
        ...
        <div className="hidden md:block overflow-hidden rounded-xl border-2 border-gray-200 shadow-2xl">
          <table className="w-full text-center border-collapse">
            <thead>
              <tr>
                <th className="p-4 bg-gray-50 w-1/3 text-gray-500 font-bold uppercase text-sm tracking-wider">Cecha</th>
                <th className="p-4 bg-green-600 text-white w-1/3 border-b-4 border-green-800 relative">
                    ...
                    <div className="absolute top-0 right-0 bg-yellow-400 text-black text-xs font-bold px-2 py-1 shadow-sm">ZWYCIĘZCA</div>
                </th>
        ...
        <div className="md:hidden space-y-6">
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500 italic">
                    Wynik: Box wygrywa 6 do 0 pod względem opłacalności.
                </p>
            </div>
        </div>
