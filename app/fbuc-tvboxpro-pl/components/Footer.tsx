    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-3">
              Elektronika i gadżety premium w cenach hurtowych. Szybka dostawa na cały świat.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="https://kizbuy.com/products#speakers" className="hover:text-amber-400">Głośniki</a></li>
              ...
              <li><a href="https://kizbuy.com/products#accessories" className="hover:text-amber-400">Akcesoria</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="https://kizbuy.com/privacy-policy" className="hover:text-amber-400">Prywatność</a></li>
              <li><a href="https://kizbuy.com/cookie-policy" className="hover:text-amber-400">Ciasteczka</a></li>
              <li><a href="https://kizbuy.com/terms-of-service" className="hover:text-amber-400">Regulamin</a></li>
            </ul>
          </div>
        </div>

        <div className="mt-8 pt-6 border-t border-gray-800 text-center">
          <p className="text-amber-400 font-semibold mb-2">TV Box Pro jest zarejestrowanym znakiem towarowym Kizbuy Ltd.</p>
        </div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-3 text-sm text-gray-500">
          <p>&copy; {year} Kizbuy Ltd. Wszelkie prawa zastrzeżone.</p>
          <div className="flex gap-4">
            <span>VAT: GB 841 3625 78</span>
            <span>Zarejestrowano w Anglii</span>
          </div>
        </div>
      </div>
    </footer>
