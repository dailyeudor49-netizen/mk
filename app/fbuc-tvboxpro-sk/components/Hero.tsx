  ...
  return (
    <section className="bg-white pb-8">
      ...
      <div className="bg-red-600 text-white text-center py-2 font-bold text-sm md:text-base px-2 uppercase tracking-wide animate-pulse">
        ⚠️ Veľký dopyt: Posledné kusy na sklade
      </div>

      <div className="max-w-4xl mx-auto px-4 pt-6">
        {/* Headline */}
        <h1 className="text-3xl md:text-5xl font-black text-center leading-tight mb-4 text-gray-900">
          PREMEŇTE SVOJ STARÝ TELEVÍZOR NA <span className="text-white bg-red-600 px-2 transform skew-x-[-10deg] inline-block">KINO, ŠTADIÓN A KONZOLU</span>
        </h1>
        <p className="text-center text-gray-700 text-lg md:text-xl font-medium mb-6 leading-relaxed">
          Prvý "Všetko v jednom" Box, ktorý prináša <span className="font-bold underline">Filmy, Živý šport a Hry</span> na každý televízor za 30 sekúnd. <span className="bg-yellow-100 px-1">Jednoduchý na používanie ako ovládač.</span>
        </p>
        ...
        <div className="flex justify-center items-center gap-2 mb-6">
          ...
          <span className="font-bold text-gray-700 underline decoration-green-500 decoration-2">6.890 Slovákov ho už používa</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start border-4 border-gray-100 p-4 rounded-xl bg-gray-50 shadow-xl">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-4 mb-6 text-left w-full">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Kino doma:</span> Všetky aplikácie (Netflix, YouTube, HBO) sú <span className="font-bold">pripravené na použitie</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Šport bez prerušení:</span> Pozerajte zápasy v 4K kvalite <span className="font-bold">bez zasekávania</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">TV sa stane Konzolou:</span> Ušetrite na PlayStatione. Joystick na hry v balení.
                </span>
              </li>
            </ul>
            ...
            >
              CHCEM OBJEDNAŤ
              <span className="block text-sm font-normal mt-1 opacity-90 text-yellow-100">Platba na dobierku (Pri doručení)</span>
            </button>
