        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-gray-600 px-4">
              Zapojte HDMI kábel do televízora. Netreba volať technika, stačí nájsť voľný vstup na zadnej strane TV.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">SPOJTE</h3>
            <p className="text-gray-600 px-4">
              Zapnite zariadenie a pripojte ho k domácemu WiFi (alebo internetu z mobilu). Funguje so všetkými operátormi.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-gray-600 px-4">
              Hotovo! Máte prístup k tisícom kanálov, filmov, seriálov a hier. Bez zmlúv a bez stresu.
            </p>
          </div>
