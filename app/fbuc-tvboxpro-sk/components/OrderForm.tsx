...
// Network config for SK (Facebook Uncapped)
      ...
      return (
          <section id="order-form" className="py-16 px-4 bg-green-50 min-h-[50vh] flex items-center justify-center">
              <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-2xl text-center border-4 border-green-500">
                  ...
                  <p className="text-xl text-gray-700 mb-6">Vaša objednávka je potvrdená.</p>
                  <p className="text-gray-600">Náš agent vás čoskoro bude kontaktovať na čísle <span className="font-bold">{formState.phone}</span> ohľadom doručenia.</p>
    ...
    <section id="order-form" className="py-12 px-4 bg-gray-200">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-300">
        ...
        <div className="bg-red-600 text-white p-6 text-center">
          ...
          <p className="text-lg font-medium">Vyplňte nižšie pre rezerváciu akcie</p>
          ...
          <div className="flex items-center justify-center gap-2 mt-4 bg-red-700 py-2 rounded-lg border border-red-500">
            ...
            <span className="font-bold text-xl">Ponuka vyprší o: {formatTime(timeLeft)}</span>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                name="phone"
                required
                placeholder="Napr. 0912 345 678"
                className="w-full p-4 border-2 border-gray-300 rounded-lg text-lg focus:border-green-500 focus:ring-green-500 outline-none"
                value={formState.phone}
                onChange={handleChange}
              />
              <p className="text-sm text-gray-500 mt-1 font-medium bg-blue-50 p-2 rounded text-blue-800">ℹ️ Dôležité: Kuriér vás bude volať na toto číslo pred doručením.</p>
            </div>

            <div>
              <label className="block text-gray-700 font-bold mb-2 text-lg">Adresa doručenia <span className="text-red-500">*</span></label>
              <textarea
                name="address"
                required
                placeholder="Mesto, Ulica, Číslo domu, Poschodie..."
                rows={3}
            ...
            <div className="bg-gray-100 p-4 rounded-lg flex items-center gap-3 text-sm text-gray-600 border border-gray-200">
               ...
               <span>Bez rizika: platíte hotovosťou až keď prevezmete balík.</span>
            </div>
