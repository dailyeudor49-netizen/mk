  ...
  return (
    <section className="bg-white pb-8">
      ...
      <div className="bg-red-600 text-white text-center py-2 font-bold text-sm md:text-base px-2 uppercase tracking-wide animate-pulse">
        ⚠️ Veliko povpraševanje: Zadnji kosi na zalogi
      </div>

      <div className="max-w-4xl mx-auto px-4 pt-6">
        {/* Headline */}
        <h1 className="text-3xl md:text-5xl font-black text-center leading-tight mb-4 text-gray-900">
          SPREMENITE STARI TELEVIZOR V <span className="text-white bg-red-600 px-2 transform skew-x-[-10deg] inline-block">KINO, STADION IN KONZOLO</span>
        </h1>
        <p className="text-center text-gray-700 text-lg md:text-xl font-medium mb-6 leading-relaxed">
          Prvi "Vse v enem" Box, ki prinaša <span className="font-bold underline">Filme, Šport v živo in Igre</span> na vsak televizor v 30 sekundah. <span className="bg-yellow-100 px-1">Tako enostaven za uporabo kot daljinec.</span>
        </p>
        ...
        <div className="flex justify-center items-center gap-2 mb-6">
          ...
          <span className="font-bold text-gray-700 underline decoration-green-500 decoration-2">4.320 Slovencev ga že uporablja</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start border-4 border-gray-100 p-4 rounded-xl bg-gray-50 shadow-xl">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-4 mb-6 text-left w-full">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Kino doma:</span> Vse aplikacije (Netflix, YouTube, HBO) so <span className="font-bold">pripravljene za uporabo</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">Šport brez prekinitev:</span> Glejte tekme v 4K kakovosti <span className="font-bold">brez zatikanja</span>.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 bg-green-600 rounded-full p-1 shrink-0"><Check size={16} className="text-white" strokeWidth={4}/></div>
                <span className="text-lg text-gray-800 leading-tight">
                  <span className="text-red-600 font-bold">TV postane Konzola:</span> Prihranite pri PlayStationu. Joystick za igre v paketu.
                </span>
              </li>
            </ul>
            ...
            >
              ŽELIM NAROČITI
              <span className="block text-sm font-normal mt-1 opacity-90 text-yellow-100">Plačilo ob prevzemu (Kurirju)</span>
            </button>
            ...
            <div className="w-full grid grid-cols-3 gap-2 py-3 border-t border-gray-200">
                <div className="flex flex-col items-center justify-start text-center">
                    ...
                    <span className="text-[10px] md:text-xs font-bold text-gray-700 leading-tight">PLAČILO<br/>OB PREVZEMU</span>
                </div>
