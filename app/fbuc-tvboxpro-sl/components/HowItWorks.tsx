    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="text-3xl font-black text-center mb-10 uppercase text-gray-900 leading-tight">
          NAMESTITEV? <br/>
          <span className="text-green-600">KOT OTROŠKA IGRA</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">POVEŽITE</h3>
            <p className="text-gray-600 px-4">
              Vtaknite HDMI kabel v televizor. Ni treba klicati tehnika, samo poiščite prost vhod na hrbtni strani TV-ja.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <h3 className="text-xl font-black uppercase mb-2 text-gray-800">PRIKLJUČITE</h3>
            <p className="text-gray-600 px-4">
              Vklopite napravo in jo povežite z domačim WiFi-jem (ali internetom s telefona). Deluje z vsemi operaterji.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <p className="text-gray-600 px-4">
              Končano! Imate dostop do tisočih kanalov, filmov, serij in iger. Brez pogodb in brez stresa.
            </p>
          </div>
