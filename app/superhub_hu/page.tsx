            ...
            <div className="flex flex-col md:flex-row items-center gap-8 hover:scale-[1.01] transition duration-500">
              <div className="md:w-1/2 order-2 md:order-1">
                <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-red-600 h-full hover:shadow-xl transition">
                  ...
                  <p className="text-slate-600 mb-4 leading-relaxed">Nyisd meg a <span className="font-bold text-slate-900 bg-yellow-100 px-1">Netflix, Max, Disney+, HBO</span> és más platformokat ugyanazon a képernyőn. Nézz sorozatmaratonokat, élvezd a legújabb filmpremieret, kapcsolj gyerekeknek mesét... minden a nappali TV-n.</p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 hover:scale-[1.01] transition duration-500">
              ...
              <div className="md:w-1/2">
                <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-blue-700 h-full hover:shadow-xl transition">
                  ...
                  <p className="text-slate-600 mb-4 leading-relaxed">Éld át a <span className="font-bold text-slate-900 bg-blue-100 px-1">magyar bajnokságot, a Bajnokok Ligáját</span> mintha a stadionban lennél. Az olyan alkalmazásokkal, mint a <span className="font-bold text-slate-900">Spíler, DIGI Sport vagy más sportcsatornák</span>, kövesd a legfontosabb eseményeket.</p>
                </div>
              </div>
            </div>
            {/* Case 3 */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 group hover:shadow-lg transition">
              ...
              <p className="text-sm text-slate-600">Netflix, Max, HBO, Spíler egy menüben.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 group hover:shadow-lg transition">
